...
def register_tools(mcp: FastMCP, client: KanboardClient) -> None:
    ...
    def getSubtask(subtask_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            subtask = client.call_api("get_subtask", subtask_id=subtask_id)
            return {
                "success": True,
                "data": subtask
            }
    ...
    def getAllSubtasks(task_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            subtasks = client.call_api("get_all_subtasks", task_id=task_id)
            return {
                "success": True,
                "data": subtasks,
    ...
    def removeSubtask(subtask_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("remove_subtask", subtask_id=subtask_id)
            return {
                "success": True,
