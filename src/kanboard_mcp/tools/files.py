...
def register_tools(mcp: FastMCP, client: KanboardClient) -> None:
    ...
    def createTaskFile(task_id: int, filename: str, blob: str) -> Dict[str, Any]:
        ...
        """
        try:
            file_id = client.call_api(method_name="create_task_file", task_id=task_id, filename=filename, blob=blob)
            return {
                "success": True,
    ...
    def downloadTaskFile(file_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            file_content = client.call_api(method_name="download_task_file", file_id=file_id)
            return {
                "success": True,
    ...
    def removeAllTaskFiles(task_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api(method_name="remove_all_task_files", task_id=task_id)
            return {
                "success": True,
                "data": {"removed": success}
            }
