...
def register_tools(mcp: FastMCP, client: KanboardClient) -> None:
    ...
    def createTaskFile(task_id: int, filename: str, blob: str) -> Dict[str, Any]:
        ...
        """
        try:
            file_id = client.call_api("create_task_file", task_id=task_id, filename=filename, blob=blob)
            return {
                "success": True,
    ...
    def getAllTaskFiles(task_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            files = client.call_api("get_all_task_files", task_id=task_id)
            return {
                "success": True,
                "data": files,
    ...
    def getTaskFile(file_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            file_info = client.call_api("get_task_file", file_id=file_id)
            return {
                "success": True,
                "data": file_info
            }
    ...
    def downloadTaskFile(file_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            file_content = client.call_api("download_task_file", file_id=file_id)
            return {
                "success": True,
    ...
    def removeTaskFile(file_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("remove_task_file", file_id=file_id)
            return {
                "success": True,
    ...
    def removeAllTaskFiles(task_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("remove_all_task_files", task_id=task_id)
            return {
                "success": True,
                "data": {"removed": success}
            }
