...
def register_tools(mcp: FastMCP, client: KanboardClient) -> None:
    ...
    def getTagsByProject(project_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            tags = client.call_api("get_tags_by_project", project_id=project_id)
            return {
                "success": True,
                "data": tags,
                "count": len(tags) if tags else 0
    ...
    def setTaskTags(task_id: int, tags: List[str]) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("set_task_tags", task_id=task_id, tags=tags)
            return {
                "success": True,
    ...
    def getTaskTags(task_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            tags = client.call_api("get_task_tags", task_id=task_id)
            return {
                "success": True,
                "data": tags,
                "count": len(tags) if tags else 0
