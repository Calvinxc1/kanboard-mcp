...
def register_tools(mcp: FastMCP, client: KanboardClient) -> None:
    ...
    def createTaskLink(task_id: int, opposite_task_id: int, link_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("create_task_link", task_id=task_id, opposite_task_id=opposite_task_id, link_id=link_id)
            return {
                "success": True,
    ...
    def updateTaskLink(task_link_id: int, task_id: int, opposite_task_id: int, link_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("update_task_link", task_link_id=task_link_id, task_id=task_id, opposite_task_id=opposite_task_id, link_id=link_id)
            return {
                "success": True,
    ...
    def getTaskLinkById(task_link_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            link = client.call_api("get_task_link_by_id", task_link_id=task_link_id)
            return {
                "success": True,
                "data": link
            }
    ...
    def getAllTaskLinks(task_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            links = client.call_api("get_all_task_links", task_id=task_id)
            return {
                "success": True,
                "data": links,
    ...
    def removeTaskLink(task_link_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("remove_task_link", task_link_id=task_link_id)
            return {
                "success": True,
    ...
    def getOppositeLinkId(link_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            opposite_id = client.call_api("get_opposite_link_id", link_id=link_id)
            return {
                "success": True,
    ...
    def getLinkByLabel(label: str) -> Dict[str, Any]:
        ...
        """
        try:
            link = client.call_api("get_link_by_label", label=label)
            return {
                "success": True,
                "data": link
            }
    ...
    def getLinkById(link_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            link = client.call_api("get_link_by_id", link_id=link_id)
            return {
                "success": True,
                "data": link
            }
    ...
    def createLink(label: str, opposite_label: str) -> Dict[str, Any]:
        ...
        """
        try:
            link_id = client.call_api("create_link", label=label, opposite_label=opposite_label)
            return {
                "success": True,
    ...
    def updateLink(link_id: int, label: str, opposite_label: str) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("update_link", link_id=link_id, label=label, opposite_label=opposite_label)
            return {
                "success": True,
                "data": {"updated": success}
            }
    ...
    def removeLink(link_id: int) -> Dict[str, Any]:
        ...
        """
        try:
            success = client.call_api("remove_link", link_id=link_id)
            return {
                "success": True,
                "data": {"removed": success}
            }
